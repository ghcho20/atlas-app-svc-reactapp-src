...
export const ClustersCard = ({ project_id }) => {
  ...
  useEffect(() => {
    async function getClusters() {
      ...
      await instance
        .get("/clusters?project_id=" + project_id)
                      ...
                      >
                        <div className="bg-white py-2 collapse-inner rounded">
                          ...
                          <span className="collapse-item">
                            Cluster State: {cluster.stateName}
                          </span>
                          <br />
                          <span className="collapse-item">
                            Paused: {cluster.paused ? "true" : "false"}
                          </span>
                          <br />
                          <span className="collapse-item">
                          ...
                          <span className="collapse-item">
                            Backup: {cluster.backupEnabled ? "true" : "false"}
                          </span>
                          <br />
                          <span className="collapse-item">
                            Auto Scaling:{" "}
                            {cluster.autoScaling.compute.enabled
                              ? "true"
                              : "false"}
                          </span>
                          <br />
                          <span className="collapse-item">
                            BI Connector:{" "}
                            {cluster.biConnector.enabled ? "true" : "false"}
                          </span>
                        </div>
                      </div>
                    </li>
